...
class GetdataSeries(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataSeries", "statistics", "prevLink", "nextLink"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetdataSeries from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetdataSeries from a dict"""
        if obj is None:
            return None
