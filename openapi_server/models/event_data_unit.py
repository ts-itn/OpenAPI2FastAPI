...
class EventDataUnit(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["statusStart", "statusEnd", "comment"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EventDataUnit from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EventDataUnit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "statusStart": obj.get("statusStart"),
            "statusEnd": obj.get("statusEnd"),
