...
class ElementShortList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ShortList", "statistics", "prevLink", "nextLink"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ElementShortList from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in short_list (list)
        _items = []
        if self.short_list:
            for _item in self.short_list:
                if _item:
                    _items.append(_item.to_dict())
            _dict['ShortList'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ElementShortList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ShortList": [ElementShort.from_dict(_item) for _item in obj.get("ShortList")] if obj.get("ShortList") is not None else None,
