...
class GetElementHeader(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["elementHeader"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetElementHeader from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetElementHeader from a dict"""
        if obj is None:
            return None
