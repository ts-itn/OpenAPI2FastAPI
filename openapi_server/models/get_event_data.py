...
class GetEventData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["eventData", "statistics", "prevLink", "nextLink"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetEventData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetEventData from a dict"""
        if obj is None:
            return None
